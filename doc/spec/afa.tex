% ==============================================================================
%  $RCSfile: afa.tex,v $, $Revision: 1.18 $
...
\begin {enumerate}
  ...
  über den allgemeinen Fehlerdialog \gq{auf einen Schlag}
...
hier beschriebenen Möglichkeiten geschehen:
   ...
   \begin {enumerate}
     ...
     bereits layouted wurden; siehe hierzu auch \ref{GUI-Fortschrittsanzeige}).
...
Unzulässige Namen werden generell abgelehnt und führen zu einer Fehlermeldung.
 ...
 Folgen von Ziffern, Buchstaben und Sonderzeichen definiert.
    ...
    \begin {enumerate}
      ...
      ASCII-Zeichen 65 bis 90 und 97 bis 122 (gemäß Definition 
...
Hier werden grundlegende Konzepte der Bedienung von GIANT beschrieben.
  ...
  \item Es gibt zu jedem Anzeigefenster beliebig viele Selektionen,
    davon ist immer eine die aktuelle Selektion (siehe
    \ref{Selektieren von Fenster-Knoten und Fenster-Kanten in
      Anzeigefenstern}).
    ...
    \item
    Der Benutzer kann jederzeit bestimmen, welche der Selektionen die
...
in Anzeigefenster}
  ...
  In diesem Abschnitt wir das Einfügen von IML-Teilgraphen und
  Selektionen in Anzeigefenster spezifiziert.
   ...
   Zielposition werden dann z.B. neue Fenster-Knoten eingefügt.\\
   Ablauf:
   ...
   \begin{enumerate}
     ...
     falls ihr Start- und Zielknoten
...
\section {Verhalten bei Umwandeln von Selektionen und IML-Teilgraphen}
  ...
  \begin {enumerate}
    ...
    \item
    Es wird ein neuer IML-Teilgraph erzeugt. Dieser umfasst alle Graph-Knoten 
    und Graph-Kanten der Selektion, welche einen gültigen Teilgraphen bilden.
