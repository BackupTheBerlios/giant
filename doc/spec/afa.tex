% ==============================================================================
%  $RCSfile: afa.tex,v $, $Revision: 1.16 $
...
in Anzeigefenster}
  ...
  Selektionen in Anzeigefenster spezifiziert.
   ...
   zur Standard-Selektion, der alte Inhalt der Standard-Selektion geht dabei verloren
   und die Standard-Selektion bekommt den Status der aktuellen Selektion.
   ...
   \begin{enumerate}
     ...
     dann zu den gleichen Bedingungen, wie unter 
...
\section {Verhalten beim Entfernen von Fenster-Knoten und Fenster-Kanten}
  ...
  Anzeigefenster werden nur die graphischen Repräsentationen der Knoten und
