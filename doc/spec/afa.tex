% ==============================================================================
%  $RCSfile: afa.tex,v $, $Revision: 1.5 $
...
\begin {enumerate}
  ...
  in einem Dialog \gq{auf einen Schlag} an den Benutzer ausgegeben.
...
\end{enumerate}
  ...
  \begin{enumerate}
    \item Können zum Betrieb von GIANT nötige Dateien nicht an der 
          ...
          und der Pfad an dem von GIANT nach diesen Dateien gesucht wird,
          angegeben.
...
Unzulässige Namen werden generell abgelehnt und führen zu einer Fehlermeldung.
  ...
  \begin {enumerate}
    ...
    \item Name eines Pins: STANDARD NAME \\
	  ...
	  innerhalb eines Anzeigfensters eindeutig sein.
 
  \end {enumerate}
 
  
\section {Allgemeine Bedienkonzepte} \index{Allgemeine Bedienkonzepte}
Hier werden grundlegende Konzepte der Bedienung von GIANT beschrieben.
  ...
  \begin{enumerate}
   ...
   \item Selektieren durch Anklicken mittels Shift + linke Maustatste.\\
...
\section {Verhalten beim Entfernen von Fenster-Knoten und Fenster-Kanten}
  ...
  Anzeigefenster werden nur die Grafischen repäsentationen der Knoten und
