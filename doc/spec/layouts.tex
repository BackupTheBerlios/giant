% ==============================================================================
%  $RCSfile: layouts.tex,v $, $Revision: 1.9 $
...
\begin{enumerate}
  ...
  \item \textbf{Wuzelknoten}\\
  Der Benutzer wählt den Wuzelknoten des zu erstellenden Baumes
  ...
  Wie auch im Begriffslexion beschrieben werden 
  ...
  berücksichtigt werden sollen. Der Layoutalgorithmus berückstichtigt
...
Der vertikale Abstand von Ebene zu Ebene richtet sich nach der H\"ohe des h\"ochsten Fenster-Knotens 
(siehe \ref{Visualization-Knoten-Rechteck}).

Falls der \"ubergebene IML-Teilgraph keinen Baum darstellt, werden die Fenster-Knoten in die Ebene 
eingegliedert, die bei einer Tiefensuche als erstes erreicht wird.

Zerf\"allt der IML-Teilgraph in nicht-zusammenh\"angende Komponenten, so wird das 
