% ==============================================================================
%  $RCSfile: layouts.tex,v $, $Revision: 1.8 $
...
In der Grundfunktionalit\"at werden alle Kanten betrachtet.
...
Falls der \"ubergebene IML-Teilgraph keinen Baum darstellt, werden die Knoten in die Ebene 
...
Die disjkunkten Bäume werden dann horizontal nebeneinander angeordnet.
