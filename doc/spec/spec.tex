% ==============================================================================
%  $RCSfile: spec.tex,v $, $Revision: 1.51 $
...
stellt lediglich eine kurze Übersicht dar, die hier 
vorgestellten Konzepte werden weiter hinten 
in diesem Dokument im Detail spezifiziert -- siehe hierzu
auch die Verweise an den entsprechenden Stellen in diesem Kapitel. 
...
die dem Benutzer über die GUI von GIANT zugängliche
Funktionalität wird in diesem Kapitel über entsprechende
...
und die nötige Software spezifiziert.
