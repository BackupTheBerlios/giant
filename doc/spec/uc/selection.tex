% ==============================================================================
%  $RCSfile: selection.tex,v $, $Revision: 1.10 $
...
Anzeigefensters (siehe auch \ref {hervorheben von Knoten und Kanten}).
  ...
  \begin{proc}    
    ...
    Selektionsauswahlliste \ref{Selektionsauswahlliste}
    und wählt im zugehörigen PopUp Menü den Eintrag
    \gq{Highlight Selection  Color1} aus.
...
Mit diesem UseCase können neue, leere Selektionen angelegt werden.
  ...
  \begin{proc}    
    ...
    die Selektionsauswahlliste (siehe \ref{Selektionsauswahlliste}
