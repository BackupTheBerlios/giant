% ==============================================================================
%  $RCSfile: selection.tex,v $, $Revision: 1.16 $
...
unverändert.
  ...
  \begin{proc}    
    ...
    aus. Falls der Benutzer die Standard-Selektion ausgewählt hat ist
...
(siehe \ref{Selektion aus IML-Teilgraphen ableiten}).
  ...
  \begin{proc} 
    ...
    \step[3] Der Benutzer gibt einen Namen (siehe auch \ref{afa
      Zulaessige Namen}) für die neu zu erstellende Selektion ein und
    bestätigt mit OK.
