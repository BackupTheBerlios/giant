% ==============================================================================
%  $RCSfile: query.tex,v $, $Revision: 1.15 $
...
\ref {GIANT Query Skripting Language} beschrieben.
  ...
  \begin{postfail}
    ...
    \cond Wurde der UseCase während der Berechnung des Skriptes 
  ...
  \begin{proc}    
    ...
    \gq{Execute GQSL Script} im Hauptmenü  
    ...
    (siehe auch Kapitel \ref{GIANT Query Skripting Language}) ein und 
    bestätigt mit \gq {OK}.

    \step[4]
    GIANT prüft das eingegebene GQSL Skript. Sollte das Skript
    nicht den Vorgaben der Grammatik 
    (siehe Kapitel \ref{GIANT Query Skripting Language}) entsprechen, erscheint
...
einer Datei (siehe \ref {Config Anfrage-Dateien}) laden.
  ...
  \begin{proc}    
    ...
    (siehe Kapitel \ref {GIANT Query Skripting Language}) im Textfeld
  ...
  \begin{aproc}
    ...
    \astep{10} Die laufende Berechnung des Skripts kann vom Benutzer
    mit Cancel abgebrochen werden.
  \end{aproc}
...
(siehe \ref {Config Anfrage-Dateien}) speichern.
  ...
  \begin{proc}    
    ...
    Vorgaben der Grammatik (siehe Kapitel \ref {GIANT Query Skripting Language}) 
    entspricht. Falls nicht, erscheint eine Fehlermeldung 
    (siehe \ref {afa Fehlerverhalten})
    und das System kehrt zu Schritt 1 zurück.
