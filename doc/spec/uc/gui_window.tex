% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.32 $
...
(siehe \ref{Verhalten beim Einfügen von IML-Teilgraphen und
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
       \item
       Falls \gq{Copy Selection keeping existing layout} gewählt wurde, wird
       ihre Position im Ziel-Anzeigefenster nicht verändert.
       
       \item 
       Falls \gq{Copy Selection changing existing layout} gewählt wurde,
...
(siehe auch \ref{Pins}) erzeugt werden.
...
Stellt die im Pin (siehe auch \ref{Pins}) gespeicherte 
