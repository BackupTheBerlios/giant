% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.21 $
...
insbesondere \ref{Einfügen von Selektionen in Anzeigefenster}.  
  ...
  \begin{proc}    
    ...
    Copy Selection with new layout oder Copy Selection with existing layout.
...
sichtbar ist
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      ...
      im Popup-Menü
      der Selektionsauswahlliste \ref{Selektionsauswahlliste} auf der 
      Selektion, welche er sichtbar machen will.
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      \item
       ...
       der Fadenkreuzcursor erscheint.
       
       \item
       Der Benutzer klickt mit der Rechten Maustaste die gewünschte Kante
       im Graphenfenster an
...
% ==============================================================================
\begin{uc}[Label]{UC: Verschieben von Knoten, Selektionen}
Knoten, Selektionen (jeweils die aktuelle Selektion),
