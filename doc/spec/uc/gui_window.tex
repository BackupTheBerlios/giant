% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.10 $
%  $Date: 2003/02/24 10:35:57 $
%  $Author: birdy $
%
...
Projektes anlegen.
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das PopUp Menü \ref{WINDOW\_LIST_POPUP}
    durch Auswahl von \gq{New Window}
    
    \step[2] 
    GIANT öffnet den allgemeinen Texteingabedialog. \ref{DIALOG\_WINDOW}.
...
Dient zum Öffnen eines Anzeigefensters des Projektes.
  ...
  \begin{proc}    
    ...
    Anzeigefenster in der \ref{WINDOW\_LIST} durch und wählt im
    PopUp Menü \ref{WINDOW\_LIST\_POPUP}  den entsprechenden Eintag aus.
...
Mit diesem UseCase wird ein geöffnetes Anzeigefenster geschlossen.
  ...
  \begin{proc}    
    ...
    Menü \ref{WINDOW\_LIST\_POPUP} in der Liste \ref{WINDOW\_LIST} schließen.
...
insbesondere \ref{Einfügen von IML-Teilgraphen in Anzeigefenster}.
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das PopUp Menü \ref{SUBGRAPH\_LIST\_POPUP}.
