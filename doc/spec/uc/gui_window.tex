% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.25 $
%  $Date: 2003/03/30 21:03:26 $
%  $Author: birdy $
%
...
Dient zum Öffnen eines Anzeigefensters des Projektes.
  ...
  \begin{proc}    
    ...
    (siehe \ref{WINDOW-LIST}) durch und wählt im
...
Abschnitt \ref{Project Persistenz der Projekte} spezifiziert.
  ...
  \begin{proc}    
    ...
    Menü \ref{WINDOW-LIST-POPUP} in der Liste über die
    Anzeigefenster des Projektes (siehe \ref{WINDOW-LIST}) schließen.
         
    \step[2]
    GIANT zeigt die allgemeine Sicherheitsabfrage 
    (siehe \ref{Sicherheitsabfrage}) und fragt nach, ob eventuelle
    Änderungen im Anziegefenster gespeichert werden sollen oder nicht
...
insbesondere \ref{Einfügen von IML-Teilgraphen in Anzeigefenster}.
  ...
  \begin{proc}    
    ...
    semantischen Layouts gibt er über den Layoutalgorithmen Dialog
    ...
    informiert wird (siehe \ref{Progressbar-Modale}).\\
    ...
    Button zum Abbruch des Algorithmus \ref{Progressbar-Modale-Cancel}.
...
\ref{Einfügen von Selektionen in Anzeigefenster}).  
  ...
  \begin{proc}    
    ...
    sollen (siehe hierzu auch \ref{Fadenkreuzcursor}).
    Die Statuszeile im Hauptfenster schaltet danach auf Normalmodus zurück.
...
Visualisierungsstile (siehe auch \ref{Config Visualisierungsstile}) ändern.
  ...
  \begin{precond}
    ...
    \cond
    Es gibt mindestens einem vom Benutzer definierten Visualisierungsstil
    (siehe hierzu auch \ref{Config Visualisierungsstile}). 
...
Verändert die Position des sichtbaren Anzeigeinhaltes.
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      ...
      und vertikalen Scrollleisten des Anzeigefensters (siehe    
...
dass eine gesamte Selektion im Anzeigefenster 
sichtbar ist.
  ...
  \begin{postsuccess}
    ...
    vergrößert oder verkleinert, dass die gesamte ausgewählte Selektion 
    sichtbar
...
dass der gesamte Fensterinhalt im Anzeigefenster sichtbar ist.
  ...
  \begin{postsuccess}
    ...
    \cond
    Der angezeigte Bereich des sichtbaren Anzeigeinhalts wurde so
    vergrößert oder verkleinert, dass der gesamte Anzeigeinhalt im sichtbaren
...
Wählt die passende Zoomstufe für den sichtbaren Anzeigeinhalt und scrollt so, 
dass eine bestimmte Kante komplett im 
sichtbaren Anzeigeinhalt liegt.
  ...
  \begin{postsuccess}
    ...
    \cond
    Der angezeigte Bereich des sichtbaren Anzeigeinhalts wurde so
    vergrößert oder verkleinert, dass die gewünschte Kante komplett
    sichtbar ist, ggf. wurde auch entsprechend gescrollt.
    Der Detaillierungslevel wurde ggf. automatisch angepasst.
...
\gq{Cut and Paste}.
  ...
  \begin{proc}    
    ...
    \begin{enumerate}
      ...
      und im Popup Menü (siehe \ref{Node-Popup-Menü}) den Eintrag
    ...
    \ref{Anzeigefenster zoomen} bleibt weiterhin verfügbar, die übrige
    Funktionalität von GIANT wird gesperrt. 
    ...
    an eine beliebige Stelle innerhalb des sichtbaren Anzeigeinhaltes
    des Anzeigefensters.
...
Siehe hierzu auch Abschnitt \ref{Auseinanderschieben von Fenster-Knoten}.
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer führt einen Linksklick auf eine beliebige Stelle
