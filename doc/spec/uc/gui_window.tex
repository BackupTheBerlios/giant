% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.36 $
...
Projektes anlegen.
  ...
  \begin{proc}    
    ...
    mit einem Namen nach dem Schema \gq{Unknown\_xx} und öffnet dies.
  \end{proc}
...
Dient zum Öffnen eines Anzeigefensters des Projektes.
  ...
  \begin{proc}    
    ...
    (siehe \ref{WINDOW-LIST-POPUP}) den \gq{Open Window} aus.
...
\ref{Project Persistenz der Projekte} spezifiziert.
  ...
  \begin{proc}
    ...
    Der Benutzer führt einen Rechtsklick auf ein Anzeigefenster in der Liste
    über die Anzeigefenster (siehe \ref{WINDOW-LIST}) durch und wählt im
    Popup-Menü \ref{WINDOW-LIST-POPUP} \gq{Save Window} aus.
...
\ref{Persistenz!Anzeigefenster} spezifiziert.
  ...
  \begin{proc}    
    ...
    Der Benutzer führt einen Rechtsklick auf ein Anzeigefenster in der Liste
    über die Anzeigefenster (siehe \ref{WINDOW-LIST}) durch und wählt im
    Popup-Menü \ref{WINDOW-LIST-POPUP} \gq{Close Window} aus.
    ...
    \step[3]
    Bestätigt der Benutzer mit \gq{Yes}, werden die Änderungen in die 
...
unwiederbringlich verloren.
  ...
  \begin{proc}    
    ...
    Der Benutzer führt einen Rechtsklick auf ein Anzeigefenster in der Liste
    über die Anzeigefenster (siehe \ref{WINDOW-LIST}) durch und wählt im
    Popup-Menü \ref{WINDOW-LIST-POPUP} \gq{Delete Window} aus.
  ...
  \begin{aproc}
    \astep{3} Der Benutzer bricht die Verarbeitung mit \gq{No} ab.
  \end{aproc}
\end{uc}
