% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.13 $
%  $Date: 2003/02/24 20:27:57 $
%  $Author: birdy $
%
...
\ref{Verhalten beim Entfernen von Fenster-Knoten und Fenster-Kanten}.
  ...
  \begin{proc}    
    ...
    entsprechenden PopUp Menü den Eintrag \ref{Delete Selection} (Delete Selection) aus.
...
Löscht einen Pin.
 ...
 \begin{precond}
  ...
  \begin{proc}    
    ...
    auf den Pin in \ref{VIS-PANE-Pins} und wählt den Eintrag \gq{Pin löschen} aus.
