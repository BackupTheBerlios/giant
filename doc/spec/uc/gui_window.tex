% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.44 $
%  $Date: 2003/04/19 19:45:43 $
%  $Author: birdy $
%
...
unwiederbringlich verloren.
  ...
  \begin{postsuccess}
    ...
    ist das Anzeigefenster jetzt natürlich auch geschlossen.
...
insbesondere \ref{Einfügen von IML-Teilgraphen in Anzeigefenster}.
  ...
  \begin{proc}    
    ...
    \step[7] GIANT berechnet das entsprechende Layout und zeigt einen
...
(siehe \ref{Verhalten beim Einfügen von IML-Teilgraphen und
  ...
  \begin{proc}    
    ...
    \gq{Copy Selection Changing Existing Layout}.
    ...
    Selektion in das Ziel-Anzeigefenster. Bei neu eingefügten 
...
Fenster-Kanten}).
  ...
  \begin{proc}    
    ...
    und wählt im Popup-Menü \gq{Delete Nodes and Edges
    of Selection} aus.
...
Verändert die Position des sichtbaren Anzeigeinhaltes.
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      ...
      Mittels der Cursortasten werden also die Scrollleisten simuliert.
      Das Drücken der linken Cursortaste entspricht z.B.\ dann einem Klick
      auf den linken Pfeil der horizontalen Scrollleiste.
...
Verändert den Maßstab der Darstellung von Fenster-Knoten und Fenster-Kanten.
  ...
  \begin{proc}    
    ...
    \step[1]
      ...
      neuen Zoomwert ein, wählt darin einen der vordefinierten Werte aus oder 
...
{UC: Zoomen auf gesamten Inhalt eines Anzeigefensters}
...
im sichtbaren Anzeigeinhalt liegt.
  ...
  \begin{postsuccess}
    ...
    Scrollen so verändert, dass die ausgewählte Fenster-Kante und ihre Start-
    und Ziel-Fenster-Knoten vollständig sichtbar sind. Die Detailstufe
