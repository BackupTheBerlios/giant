% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.28 $
...
gehen hierbei unwiederbringlich verloren.
  ...
  \begin{proc}    
    ...
    \gq{Do you really want to delete the selected window?}
...
Dient zum Öffnen eines Anzeigefensters des Projektes.
  ...
  \begin{proc}    
    ...
    Popup Menü \ref{WINDOW-LIST-POPUP} den entsprechenden Eintrag aus.
...
Mit diesem UseCase kann eine Selektion aus einem Anzeigefenster in ein
