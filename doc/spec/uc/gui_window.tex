% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.8 $
...
Verändert die Position des sichtbaren Anzeigeinhaltes.
  ...
  \begin{proc}    
    ...
    und vertikalen Scrollleisten des Anzeigefensterts. Dies geschieht
    gemäß der gängigen Konventionen aus GTK/Ada für Scrollleisten.
    <<<<<<<<<<<<<<<<VERWEIS GUI>>>>>>>>>>>>>>>>>>
...
Dieser UseCase wir benötigt, um Fenster-Knoten auseinander schieben zu 
