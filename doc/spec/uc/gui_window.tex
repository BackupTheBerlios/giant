% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.39 $
...
\ref{Project Persistenz der Projekte} spezifiziert.
  ...
  \begin{postsuccess}  
    ...
    Änderungen sind jetzt in der Verwaltungsdatei des Anzeigefensters
...
(siehe \ref{Verhalten beim Einfügen von IML-Teilgraphen und
  ...
  \begin{proc}    
    ...
    in etwa dem Punkt, an dem der Mittelpunkt eines die zu kopierende
...
Fenster-Kanten}).
  ...
  \begin{proc}    
    ...
    und wählt im entsprechenden Popup-Menü \gq{Delete Nodes and Edges
    of Selection} aus.
...
im sichtbaren Anzeigeinhalt liegt.
  ...
  \begin{aproc}
    ...
    einen Rechtsklick mit der Maus (dem Fadenkreuzcursor) auf eine
...
\gq{Cut and Paste}.
  ...
  \begin{postsuccess}
    ...
    wurden im Anzeigeinhalt verschoben. Das Layout der Fensterknoten
