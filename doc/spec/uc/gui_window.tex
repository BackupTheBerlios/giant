% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.12 $
%  $Date: 2003/02/24 18:58:50 $
%  $Author: birdy $
%
...
insbesondere \ref{Einfügen von Selektionen in Anzeigefenster}.
  ...
  \begin{proc}    
    ...
    \ref{PopUp Menü Subgraph List}
    Durch Auswahl einer der Menüeinträge 
    \ref{PopUp Menue Subgraph List-Old layout} oder \ref{PopUp Menue Subgraph List-New layout},
    also Copy IML Subgraph with existing layout oder Copy IML Subgraph with new layout.
