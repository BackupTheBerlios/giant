% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.30 $
%  $Date: 2003/04/03 20:51:11 $
%  $Author: squig $
%
...
Projektes anlegen.
  ...
  \begin{proc}    
    ...
    mit einem Namen nach dem Schema ,,Unknown\_??'' und öffnet dies.
  \end{proc}

  \begin{aproc}
    \ageneral Es sind keine alternativen Abläufe vorgesehen.
  \end{aproc}
\end{uc}
...
Dient zum Öffnen eines Anzeigefensters des Projektes.
  ...
  \begin{postfail}
    \cond Es sind keine Fehlerfälle vorgesehen.
  \end{postfail}
...
Dient zum Umbenennen eines Anzeigefensters des Projektes.
  ...
  \begin{proc}    
    ...
    Popup Menü \ref{WINDOW-LIST-POPUP} den Eintrag ,,Rename'' aus.
...
\ref{Project Persistenz der Projekte} spezifiziert.
  ...
  \begin{proc}
    ...
    Der Benutzer führt einen Rechtsklick auf ein Anzeigefenster in der Liste
    über die Anzeigefenster (siehe \ref{WINDOW-LIST}) durch und wählt im
    Popup Menü \ref{WINDOW-LIST-POPUP} den Eintrag ,,Save'' aus.
...
unwiederbringlich verloren.
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das
    Popup-Menü \ref{WINDOW-LIST-POPUP}.
...
% ==============================================================================
\begin{uc}[Zoomen auf eine gesamte Selektion]{UC: Zoomen auf eine gesamte Selektion}
...
% ==============================================================================
\begin{uc}[Zoomen auf gesamten Inhalt eines Anzeigefensters]{UC: Zoomen auf gesamten Inhalt eines Anzeigefensters}
