% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.31 $
...
Näheres zur Persistenz von Anzeigefenstern ist unter Abschnitt
\ref{Project Verwaltungsdateien für Anzeigefenster} spezifiziert.
...
Fenster-Kanten}).
  ...
  \begin{proc}    
    ...
    \step[3]
    Der Benutzer bestätigt mit \gq{Yes}.
...
Visualisierungsstile ändern (siehe auch \ref{Config Visualisierungsstile}).
  ...
  \begin{precond}
    ...
    \cond
    Es gibt mindestens einen vom Benutzer definierten Visualisierungsstil
...
Verändert die Position des sichtbaren Anzeigeinhaltes.
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      ...
      der Maus gemäß der gängigen Konventionen von GTK/Ada für Bildlaufleisten.
      
      \item
      Gemäß der gängigen Konventionen kann auch 
