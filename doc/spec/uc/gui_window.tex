% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.23 $
...
Wählt die Zoomstufe \index{Zoomstufe} und scrollt so, daß eine gesamte Selektion im Fenster 
sichtbar ist.
...
Drop auf dem sichtbaren Anzeigeinhalt verschoben werden.
  ...
  \begin{proc}    
    ...
    Anzeigeinhaltes und lässt die linke Maustatste los (\gq{Drop}.\\
    Während ein Knoten sich im Zustand \gq{Dragged} befindet kann
    der sichtbare Anzeigeinhalt ausschließlich mit den Cursortasten 
    analog zu UseCase \ref{Anzeigefenster scrollen} gescrollt werden.
    Jede andere Funktionalität (auch Zoomen) ist während des \gq{Drag and
    Drop} vorganges gesperrt.
...
Siehe hierzu auch Abschnitt \ref{Auseinanderschieben von Fenster-Knoten}.
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer führt einen Linksklick auf eine bliebige Stelle
  ...
  \begin{aproc}
    ...
    \astep{3} Der Benutzer kann den UseCase durch Betätigen des \gq{Cancel}
              Buttons abbrechen.
...
(siehe auch \index{Pins}) erzeugt werden.
 ...
 \begin{precond}
  ...
  \begin{proc}    
    ...
    Der Benutzer führt einen Rechtklick auf den Anzeigeinhalt eines
...
Stellt die im Pin (siehe auch \index{Pins}) gespeicherte 
Position des sichtbaren Anzeigeinhaltes wieder her.
 ...
 \begin{precond}
  ...
  \begin{proc}    
    ...
    Das \gq{Anspringen} des Pins kann über die folgenden beiden
    ...
    \begin{enumerate}
      ...
      \item
      Der Benutzer öffnet ein PopUp-Menü durch
      Rechtsklick auf den anzuspringenden Pin 
      in der Pinliste (siehe \ref{VIS-PANE-Pins}) und wählt den Eintrag
      \gq{Focus Pin} aus.
    ...
    \step[2]
    GIANT \gq{springt den Pin an} und setzt den sichtbaren 
    Anzeigeinhalt gemäß den im Pin gespeicherten
    Informationen.
...
Löscht einen Pin (siehe auch \index{Pins}).
