% ==============================================================================
%  $RCSfile: gui_window.tex,v $, $Revision: 1.27 $
%  $Date: 2003/03/31 21:49:58 $
%  $Author: schulzgt $
%
...
Abschnitt \ref{Project Persistenz der Projekte} spezifiziert.
  ...
  \begin{proc}    
    ...
    \step[1] Der Benutzer schließt das Anzeigefenster (durch klicken
    auf das ''X''
    Symbol rechts oben in der Titelleiste des Anzeigefensters).\\
    Alternativ kann er das Anzeigefenster über das entsprechende
    Popup-Menü \ref{WINDOW-LIST-POPUP} in der Liste über die
...
Verändert die Position des sichtbaren Anzeigeinhaltes.
  ...
  \begin{proc}    
    ...
    \begin {enumerate}
      ...
      und vertikalen Bildlaufleisten des Anzeigefensters (siehe    
      \ref{Scrolleisten}). Dies geschieht mittels
      der Maus gemäß der gängigen Konventionen aus GTK/Ada für Bildlaufleisten.
...
sichtbaren Anzeigeinhalt liegt.
  ...
  \begin{postsuccess}
    ...
    Die Detailstufen wurde ggf. automatisch angepasst.
...
\gq{Cut and Paste}.
  ...
  \begin{proc}    
    ...
    \step[3]
    Der Benutzer klickt mit dem Fadenkreuz-Cursor (linke Maustaste)
