% ==============================================================================
%  $RCSfile: additional.tex,v $, $Revision: 1.19 $
...
\ref{Layoutalgorithmen} beschrieben.
  ...
  \begin{proc}
    ...
    \step[6]
    GIANT berechnet das Layout und zeigt eine Progressbar 
    (siehe \ref{Progressbar-Modale}) an. 
    Während der Berechnung des Layouts ist die GUI mit Ausnahme der
    Progressbar gesperrt.
