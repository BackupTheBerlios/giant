% ==============================================================================
%  $RCSfile: additional.tex,v $, $Revision: 1.15 $
...
anzeigen lassen.
  ...
  \begin{precond}
    ...
    \cond Es gibt mindestens ein offenes Knoten-Informationsfenster.
...
\begin{uc}[Anzeige des Quellcodes eines Knotens in externem Editor]
...
zur Anzeige gebracht werden.
  ...
  \begin{proc}    
    ...
    einem Editor (falls die Information zur Quellcode Datei
    für den IML-Knoten vefügbar ist).
