% ==============================================================================
%  $RCSfile: subgraph.tex,v $, $Revision: 1.10 $
...
Anzeigefenster (siehe hierzu auch \ref {hervorheben von Knoten und Kanten}).
  ...
  \begin{proc}    
    ...
    wählt er den Eintrag \gq {Highlight with Color 1 (2,3)}
    aus.
...
Siehe hierzu auch Abschnitt \ref{IML-Teilgraphen aus Selektion ableiten}.
...
(siehe \ref {GIANT Query Skripting Language}) kann der Benutzer
