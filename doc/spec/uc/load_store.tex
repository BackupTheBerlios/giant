% ==============================================================================
%  $RCSfile: load_store.tex,v $, $Revision: 1.18 $
...
\index{Projekte!neues Projekt erstellen}
  ...
  \begin{proc}
    ...
    (siehe \ref{Main-Window-File}) durch Auswahl von \gq{New Project}.
...
\index{Projekte!öffnen}
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das Hauptmenü
    (siehe \ref{Main-Window-File} Menü) durch Auswahl von \gq{Load Project}.
...
\index{Projekte!speichern}
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das Hauptmenü
    (siehe \ref{Main-Window-File}) durch Auswahl von \gq{Save Project}.
...
(entsprechende Verwaltungsdateien werden ebenfalls dupliziert).
  ...
  \begin{proc}    
    \step[1]
    Der Benutzer startet den UseCase über das Hauptmenü
    (siehe \ref{Main-Window-File}) durch Auswahl von \gq{Save Project As...}.
