% ==============================================================================
%  $RCSfile: load_store.tex,v $, $Revision: 1.20 $
%  $Date: 2003/04/17 00:29:18 $
%  $Author: schwiemn $
%
...
\index{Projekte!neues Projekt erstellen}
  ...
  \begin{proc}
    ...
    Path and Project File Name}) ein, die Dateiendung wird später
    ...
    erzeugt ein neues Projekt und öffnet dieses.
...
(entsprechende Verwaltungsdateien werden ebenfalls dupliziert).
  ...
  \begin{proc}    
    ...
    \step[2] Der Benutzer gibt im Standard-Filechooser-Dialog 
             ...
             (siehe \ref{Project Die Projektdatei}) vor, die Dateiendung 
    ...
    Existiert in dem angebebenen Projektverzeichnis 
