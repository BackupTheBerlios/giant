% =============================================================================
%  $RCSfile: gsl.tex,v $ $Revision: 1.11 $
%  $Date: 2003/06/24 21:20:50 $
%  $Author: keulsn $
%
...
\item Der \nscriptbody der durch $I$ referenziert wird, wird
...
dessen Ergebnis
ein Wert vom Typ \tboolean oder \tscriptreference ist.}
...
entsprechende Script ohne Argumente aktiviert. Ist das Ergebnis wieder
eine Aktivierungsinformation, so wird das so referenzierte Script
aktiviert. Dieser Schritt wird iteriert solange bis das Ergebnis ein
Wert $b$ vom Typ \tboolean ist.

 Falls condition vom Typ \tboolean ist, so ist
$b =$ condition.
...
\sresult{\tedgeid}{Nachbereich von n}
