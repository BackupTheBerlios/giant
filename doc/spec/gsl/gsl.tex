% =============================================================================
%  $RCSfile: gsl.tex,v $ $Revision: 1.19 $
%  $Date: 2003/10/06 17:29:49 $
%  $Author: koppor $
%
...
\sparam{class\_set}{\tstring}{Name einer Klassenmenge}
\sresult{\tboolean}{\toktrue, falls die Klasse der IML-Kante e zu der
  Klassenmenge class\_set gehört. \tokfalse sonst.}
\saction{Prüft, ob eine bestimmte Kante zu einer Klassenmenge
  gehört. Falls class\_set keine konfigurierte Klassenmenge ist, so
  ist dies ein Laufzeitfehler.}
\end{scriptdef}
