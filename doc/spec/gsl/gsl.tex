% =============================================================================
%  $RCSfile: gsl.tex,v $ $Revision: 1.3 $
%  $Date: 2003/04/23 00:53:38 $
%  $Author: keulsn $
%
...
andernfalls führt die Auswertung zu einem Laufzeitfehler. Durch diese
Einschränkung wird sichergestellt, dass zu keinem Zeitpunkt ein Wert
eines der genannten Typen existiert, der ein Objekt referenziert, das an
keine Variable gebunden ist.}
\end{scriptdef}
...
je einmal. Übergibt das Element an action als einzigen Parameter.}
\end{scriptdef}
