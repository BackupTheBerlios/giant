% =============================================================================
%  $RCSfile: gsl.tex,v $ $Revision: 1.15 $
%  $Date: 2003/08/26 10:54:07 $
%  $Author: keulsn $
%
...
gewähltes)  Element aus der Menge}
\end{scriptdef}
...
\sresult{\tboolean}{\toktrue, falls der IML-Knoten n ein IML-Knoten
des Typs class ist oder als Typ eine IML-Knoteklasse hat, die class
beerbt. \tokfalse sonst.}
\saction{Testet, ob ein bestimmter IML-Knoten einer bestimmten
IML-Knotenklasse angehört.}
\end{scriptdef}
