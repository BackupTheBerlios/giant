% =============================================================================
%  $RCSfile: language.tex,v $, $Revision: 1.5 $
%  $Date: 2003/04/07 05:45:39 $
%  $Author: keulsn $
%
%  Description:
%
...
\gqslexpression korrekt ausgewertet werden und keine Einschränkung aus
...
Der Wert der \gqslliteralexpression ist die Interpretation die
...
\gqslattribexpr wird erfolgreich ausgewertet, falls auf der rechten Seite
...
erfolgreich ausgewertet werden. Andernfalls wird fehlerhaft ausgewertet.
\item Das \gqslnodepredicate bzw. das \gqsledgepredicate bzw. die
...
erfolgreich ausgewertet, falls auf der rechten Seite das
...
ausgewertet werden. Andernfalls ist die Auswertung fehlerhaft.
\item Das \gqslnodechoosingproduct bzw. das \gqsledgechoosingproduct bzw.
das \gqslattribproduct wird
...
beeinflussen.
  ...
  bzw. das \gqslattribstatement wird erfolgreich ausgewertet, falls auf der
  rechten Seite das \gqslnodepredicate bzw. das \gqsledgepredicate bzw. die
  \gqslattribexpr erfolgreich ausgewertet wird. Andernfalls ist die
  Auswertung fehlerhaft.
  \item Das \gqslnodechoosingstatement bzw. das \gqsledgechoosingstatement
...
\item[Negation] Logische Negation.
  ...
  \gqslattribstatement erfolgreich ausgewertet wird. Andernfalls ist die
  Auswertung fehlerhaft.
  \item Das \gqslnodechoosingstatement bzw. das \gqsledgechoosingstatement
...
\item[Simple Statement] Logische Aussage.
  ...
  das \gqslsimpleattribstatement erfolgreich ausgewertet wird.
  Andernfalls ist die
  Auswertung fehlerhaft.
  \item Das \gqslnodechoosingstatement bzw. das \gqsledgechoosingstatement
...
so wird \gqslattribatomicvalue auf dem Knoten $M$ ausgewertet, auf den $a$
verweist.
...
\gqslattribatomicvalue.
\item Falls die Auswertung erfolgreich ist, so ist der Wert der Wert der
Auswertung von \gqslattribatomicvalue.
\end{enumerate}
...
\begin{enumerate}
\item Das \gqslsimpleattribstatement wird erfolgreich ausgewertet, falls
das \gqslattribatomicvalue erfolgreich ausgewertet wird und die
\gqslexpression entweder nicht angegeben ist oder erfolgreich ausgewertet wird.
Andernfalls wird das \gqslsimpleattribstatement fehlerhaft ausgewertet.
...
\gqslattribatomicvalue, \gqslexpression und des \gqslcompop zulässig:
  ...
  \gqslattribatomicvalue den Wert true hat.
  ...
  Das \gqslsimpleattribstatement wird erfüllt, falls der Ausdruck nach der
  mathematischen Definition korrekt ist.
  \item[String, \tokstring] Zulässig sind alle Möglichkeiten für \gqslcompop.
  Das \gqslsimpleattribstatement wird erfüllt falls der entstehende Ausdruck
  korrekt ist. Eine Zeichenfolge $a$ gilt als kleiner als eine Zeichenfolge
  $b$, falls $a$ lexikographisch von $b$ kommt.
  \end{description}
\end{enumerate}
...
\begin{enumerate}
\item Das \gqslsimpleattribstatement wird erfolgreich ausgewertet, falls
das \gqslattribatomicvalue erfolgreich ausgewertet wird und vom Typ String
ist.
Andernfalls wird das \gqslsimpleattribstatement fehlerhaft ausgewertet.
\item Das \gqslsimpleattribstatement wird erfüllt, falls
\gqslattribatomicvalue in der durch \gqslregexp gegebenen Sprache enthalten
ist. Andernfalls wird \gqslsimpleattribstatement nicht erfüllt.
\end{enumerate}
...
Falls \texttt{Selection\_Name} kein gültiger Name für Selektionen ist,
