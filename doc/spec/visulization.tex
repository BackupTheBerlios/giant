% ==============================================================================
%  $RCSfile: visulization.tex,v $, $Revision: 1.9 $
%  $Date: 2003/02/25 14:33:50 $
%  $Author: squig $
%
%  Description:
%
...
stark von der aktuellen Zoomstufe und dem gewählten Visualisierungsstiel ab.
  ...
  verfasst wurde, zeigt dies über ein entsprechendes Icon rechts oben im
  Knoten-Rechteck an.
...
\end {enumerate}
  ...
  >>>>>>>>>>>>>>>>>>>>>>>>>>>> EVENTUELL GANZ WEG LASSEN
  Kantenknickpunkte sind vorerst nicht vorgesehen.
