% ==============================================================================
%  $RCSfile: visulization.tex,v $, $Revision: 1.6 $
...
stark von der aktuellen Zoomstufe und dem gewählten Visualisierungsstiel ab.
  ...
  angezeigt.\\  Der Name der Knotenlklasse wird bei den Attributen angezeigt.
...
unterschiedbar hervorgehoben werden.
  ...
  mittels einer definierbaren Farbe eingefärbt.
    ...
    \begin {enumerate} 
      ...
      so werden die Knoten-Rechtecke entsprechend mehrfarbig gefüllt.
...
\begin {enumerate}
  ...
  \item
  Beim Herauszoomen müssen also Details abstrahiert werden, 
...
Es wird hierzu in etwa die folgenden Detailstufen geben:
