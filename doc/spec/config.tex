% ==============================================================================
%  $RCSfile: config.tex,v $, $Revision: 1.28 $
%  $Date: 2003/04/17 22:44:58 $
%  $Author: schwiemn $
%
%  Description:
%
...
%EVENTUELL FÜR JEDEN BENUTZER EIGENE KONFIGURATIONS-DATEI VORSEHEN.
  ...
  \subsection {Verweise auf GQSL-Skripte} 
  \index{Makros}
  \index{GQSL!Makros}
...
\end {enumerate}
  ...
  und druch den Namen des Attribtes, welches die Kante darstellt, 
...
\index{GQSL!Skriptdateien} \index{Skriptdateien}

Eine Textdatei, die genau ein GQSL Skript enthält 
...
Für eine exakte Spezifikation der GQSL siehe Kapitel 
\ref {GIANT Query Skripting Language}. 
