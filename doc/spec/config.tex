% ==============================================================================
%  $RCSfile: config.tex,v $, $Revision: 1.36 $
%  $Date: 2003/09/05 19:55:52 $
%  $Author: birdy $
%
%  Description:
%
...
\begin {enumerate}
  ...
  \item
  Die konfigurierbaren Einstellungen werden in XML-Dateien vorgenommen.
  
  \item \label{config-allgemeines-punkt2}
  \index{Konfigurationsdatei!globale}
  Es gibt zwei \gq{globale Konfigurationsdateien}. Ausserdem kann es beliebig 
  viele weitere XML-Dateien zur Konfiguration geben, diese werden in den
  folgenden Kapiteln beschrieben.\\
  Einstellungen aus globalen Konfigurationsdateien können durch \gq{lokale}
