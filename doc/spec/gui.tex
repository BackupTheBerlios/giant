% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.8 $
%  $Date: 2003/02/18 12:36:18 $
%  $Author: birdy $
%
  ...
  Im Fenster befindet sich zuoberst eine Liste WINDOW\_LIST.
    ...
    \subsubsection {PopUp Menü Window list}
        ...
        \begin{enumerate}
          ...
          \item Fenster löschen
          \item Neues Fenster
          \item IML-Teilgraph einfügen
          \item Fenster exportieren
          \item Fenster importieren
          \end{enumerate}
  ...
  \subsection {Subgraph List}
    ...
    \subsubsection {PopUp Menü Subgraph List}
      ...
      Beim Rechtsklick auf SUBGRAPH\_LIST öffnet sich ein Popup-Menü mit folgenden Menüpunkten:
        ...
        \begin{enumerate}
          \item hervorheben (zum Hervorheben eines Teilgraphen in allen Fenstern mit Farbe SUBGRAPH\_COL)
          \item Hervorhebungsfarbe ändern
          \item hervorheben aufheben
          \item Teilgraph kopieren
          \item Teilgraph umbenennen
          \item Teilgraph löschen
          \item Teilgraphen Mengenoperation (Vereinigung/Differenz/Schnitt)
          \item Teilgraphen exportieren
          \item Teilgraphen importieren
        \end{enumerate}   
...
\section{Anzeigefenster}
  ...
  \subsection{Pins}
    ...
    \begin{enumerate}
      \item Neuer Pin (PIN\_NEW)
      \item Zu Pin springen (PIN\_JUMP),
      \item Pin löschen (PIN\_DELETE).
    \end{enumerate}
  ...
  \subsection{Selektionen}
    ...
    \begin{enumerate}
      \item Neue Selektion
      \item Zur Selektion hinzufügen
      \item hervorheben (zum Hervorheben einer Selektion in der Farbe SELECTION\_COL)
      \item Hervorhebungsfarbe ändern
      \item hervorheben aufheben
      \item Selektion kopieren
      \item Selektion umbenennen
      \item Selektion löschen
      \item Selektion Mengenoperation (Vereinigung/Differenz/Schnitt)
      \item Selektion exportieren
      \item Selektion importieren
    \end{enumerate}    
...
\section{Knoten-Informationsfenster}
    ...
    \subsection{Liste ATTRIBUTES}
      ...
      \begin{enumerate}
        \item ATTRIBUTE (Attributname)
        \item VALUE (Wert des Attributs)
      \end{enumerate}
    
    \subsection{Liste SUCCESSOR\_NODES}
    
      Die Liste SUCCESSOR\_EDGES hat eine Zeile für jede vom Knoten abgehende
      Kante mit drei Spalten (Typ der abgehenden Kante, Typ des Knotens,
      zu dem sie führt, ID des Knotens, zu dem sie führt) :
    ...
    \subsection{Liste PREDECESSOR\_NODES}
      ...
      Kante mit drei Spalten (Typ der ankommenden Kante, Typ des Knotens,
      von dem sie kommt, ID des Knotens, von dem sie kommt) :
...
Unter QUERY\_TEXT befinden sich folgende Elemente:
      ...
      \begin{enumerate}
        \item Button QUERY\_START
        \item Button QUERY\_CANCEL
        \item Button QUERY\_LOAD
        \item Button QUERY\_SAVE
      \end{enumerate}
