% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.57 $
%  $Date: 2003/03/29 19:28:00 $
%  $Author: koppor $
%
%  Description: 
%
...
\label{Common-Set-Operation-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics{Common_Set_Operation_Dialog}
...
\section {Layoutalgorithmen Dialog}\label{Layoutalgorithmen-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics{Layout_Algorithm_Dialog}
