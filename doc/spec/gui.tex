% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.43 $
...
und darunter SUBGRAPH\_LIST (4 Spalten).
  ...
  \subsection {Subgraph List}
    ...
    \label {PopUp Menü Subgraph List}
      Beim Rechtsklick auf SUBGRAPH\_LIST öffnet sich ein Popup-Menü mit folgenden Menüpunkten:
        ...
        \begin{enumerate}
          \item highlight in all windows (zum Hervorheben eines Teilgraphen in allen Fenstern mit Farbe SUBGRAPH\_COL)
  ...
  \subsection {Zugehörige Dialoge}
        ...
        \begin{enumerate}
			...
			Er hat ein Textfeld mit der Beschriftung \gq{Name for New Window},
