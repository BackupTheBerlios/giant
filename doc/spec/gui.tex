% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.74 $
%  $Date: 2003/04/17 10:57:34 $
%  $Author: birdy $
%
%  Description: 
%
...
\section{Knoten-Informationsfenster} \label{Knoten-Informationsfenster}
    ...
    \subsection{Liste Successor Edges}
    
      Die Liste Successor Edges hat eine Zeile für jede vom Knoten abgehende
    ...
    \subsection{Liste Predecessor Edges}
      
      Die Liste Predecessor Edges hat eine Zeile für jede vom Knoten abgehende
      Kante mit zwei Spalten:
