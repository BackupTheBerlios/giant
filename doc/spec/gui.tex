% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.21 $
...
- Auswahl des Layoutalgorithmus\\
- Eingabe der zu berücksichtigenden Kanten bei semantischen Layouts\\
- OK Button\\
- Cancel Button\\
- Textfeld zur Eingabe des Namens für die Selektion (in dem ANziegefenster
wo sie eingefügt wurde).
