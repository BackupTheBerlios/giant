% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.83 $
%  $Date: 2003/04/19 15:53:08 $
%  $Author: birdy $
%
%  Description: 
%
...
\begin {enumerate}
 ...
 \item {Eingabe der zu berücksichtigenden Kanten bei semantischen Layouts
 	Hierbei können mittels der Buttons \gq{>>} und \gq{<<} die 
        verfügbaren
	definierten Listen von Knoten- und Kantenklassen zwischen den beiden
	Spalten \gq{Available} und \gq{Use For Layout} 
        hin und her geschoben werden.
	Nur Kantenlisten, die sich in der \gq{Use For Layout} Spalte befinden,
