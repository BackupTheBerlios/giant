% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.49 $
%  $Date: 2003/03/29 09:12:56 $
%  $Author: birdy $
%
...
\index{Anzeigefenster}
 ...
 \subsection {Minimap} \label{GUI Minimap}
  ...
  \subsection{Pins} \label{VIS-PANE-Pins}
    ...
    \begin{enumerate}
       %  \item New Pin (PIN\_NEW)  gestichen von Martin
...
\begin {enumerate}
 ...
 \item OK Button
 \item Cancel Button
 \item Textfeld zur Eingabe des Namens für die Selektion (in dem Anzeigefenster wo sie 
       eingefügt wurde)
\end {enumerate}
