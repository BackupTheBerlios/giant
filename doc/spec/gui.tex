% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.79 $
%  $Date: 2003/04/18 16:33:29 $
%  $Author: birdy $
%
%  Description: 
%
...
\index{Anzeigefenster}
 ...
 versetzt, der sichtbare Anzeigeinhalt in der Vis Pane entsprechend
 angepasst.
...
\section{Knoten-Informationsfenster} \label{Knoten-Informationsfenster}
    ...
    \begin{enumerate}
      \item ID (Typ der abgehenden Kante)
      \item Type (ID des Knotens, zu dem sie führt)
    \end{enumerate}    
    ...
    \subsection{Liste Predecessor Nodes}
      ...
      \begin{enumerate}
        ...
        \item Type (Typ der ankommenden Kante)
      \end{enumerate}
...
\begin {enumerate}
 ...
 Mit den beiden Buttons OK und Cancel läßt sich die Operation starten bzw.
...
\begin {enumerate}
 ...
 \item {Eingabe der zu berücksichtigenden Kanten bei semantischen Layouts
 	Hierbei können mittels der Buttons >> und << die verfügbaren
	definierten Listen von Knoten- und Kantentypen zwischen den beiden
	Listen Available und Use For Layout hin und her geschoben werden.
	Nur Kantenlisten, die sich in der Use For Layout Spalte befinden,
...
Im Dialogfenster Make Room (\ref{Make-Room-Dialog-Pic}) wird in einem Textfeld als Zahl angegeben, um wieviel
...
Eine allgemeine Sicherheitsabfrage (\ref{Confirmation-Window-Pic}) ist ein Fenster Confirmation Window mit dem
