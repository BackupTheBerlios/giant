% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.23 $
%  $Date: 2003/02/24 10:36:10 $
%  $Author: birdy $
%
...
und darunter SUBGRAPH\_LIST (4 Spalten).
  ...
  \subsection {Zugehörige Dialoge}
  	...
  	\begin{enumerate}
		\label SUBGRAPH\_LIST/NEW\_WINDOW
...
\section {Layoutalgorithmen Dialog}
...
>>>> AUSFORMULIEREN und ENTSPRECHEND FORMATIEREN


\item Auswahl des Layoutalgorithmus\\
	Hiermit kann der Layoutalgorithmus ausgewählt werden.
...
\label{Fadenkreuzcursor}
	...
	Funktionen in ein Fadenkreuz. Durch Rechtsklick auf einen
	Knoten/eine Kante in einem Fenster wird dieser Knoten/diese
	Kante für die jeweilige Funktion ausgewählt. Der Cursor verwandelt
