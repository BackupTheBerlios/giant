% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.78 $
%  $Date: 2003/04/18 13:34:22 $
%  $Author: birdy $
%
%  Description: 
%
...
Im Hauptfenster (Main Window) werden vorhandene Anzeigefenster und
...
Ein allgemeiner Texteingabedialog ist ein Fenster Dialog Window mit dem
...
Im Dialogfenster Make Room wird in einem Textfeld als Zahl angegeben, um wieviel
...
Ein allgemeiner Fehlerdialog ist ein Fenster Error Window mit dem
...
Eine allgemeine Sicherheitsabfrage ist ein Fenster Confirmation Window mit dem
