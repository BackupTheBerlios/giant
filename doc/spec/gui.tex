% ==============================================================================
%  $RCSfile: gui.tex,v $, $Revision: 1.56 $
%  $Date: 2003/03/29 19:02:58 $
%  $Author: birdy $
%
%  Description: 
%
...
\begin{figure}[!htbp]
   \centering
   \includegraphics[10cm,10cm][0,0]{Main_Window.png}
   \caption{Main-Window}
\end{figure}
...
\index{Anzeigefenster}
  ...
  \begin{figure}[!htbp]
     \centering
     \includegraphics[10cm,10cm][0,0]{Graph_Window.png}
  ...
  und  ein Button zum Ausblenden der Toolbar (TOOLBAR\_HIDE).
...
\section{Knoten-Informationsfenster} \label{Knoten-Informationsfenster}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Node_Info_Window.png}
...
\section{Anfragedialog} \label{GUI Anfragedialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Query_Dialog.png}
...
\label{DIALOG-WINDOW}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Dialog_Window.png}
...
\label{Common-Set-Operation-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Common_Set_Operation_Dialog.png}
...
\section {Layoutalgorithmen Dialog}\label{Layoutalgorithmen-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Layout_Algorithm_Dialog.png}
...
\label{Knoten Annotations-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Node_Annotation_Dialog.png}
...
\label{Platz Schaffen-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Make_Room_Dialog.png}
...
\label {GUI Ausgabe von Fehlermeldungen}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Error_Window.png}
...
\index{Sicherheitsabfrage}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Confirmation_Window.png}
...
\section{Auswahl von Dateien}
  ...
  \label {Standard-Filechooser-Dialog}
    ...
    \begin{figure}[!htbp]
       \centering
       \includegraphics[10cm,10cm][0,0]{Filechooser.png}
...
\label{Progressbar-Runs}
     ...
     \begin{figure}[!htbp]
      \centering
      \includegraphics[10cm,10cm][0,0]{Progressbar-Runs.png}
...
\label{Progressbar-Status} 
     ...
     \begin{figure}[!htbp]
      \centering
      \includegraphics[10cm,10cm][0,0]{Modal-Progressbar.png}
