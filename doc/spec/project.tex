% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.14 $
...
\section {Grundlegendes Verhalten von GIANT beim Speichern von Projekten} 
  ...
  Verfügung gestellt. Hierbei werden alle Anzeigefenster, IML-Teilgraphen 
  und Knoten-Annotationen in die Verwaltungsdateien geschrieben, 
  wobei alle Änderungen an noch offenen Anzeigefenstern berücksichtigt werden.
...
\subsection {Persistenz von Knoten-Annotationen}
  \begin {enumerate}
   ...
   über \gq{alles Speichern} in die Verwaltungsdatei geschrieben.
