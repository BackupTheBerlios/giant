% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.23 $
...
%===================
\section {Persistenz der Projekte}\index{Persistenz} \index {Projekte}
...
\begin {enumerate}
  ...
  GIANT unterstützt dies durch den Einsatz von XML. Insbesondere
  kann der Benutzer die Projektdatei (siehe \ref{Project Die Projektdatei})
  ...
  Das Fehrhalten von GIANT gegenüber Fehlern aufgrund manueller Änderungen
  ...
  ausserhalb der Projektverzeichnisses eintragen; verboten ist dies
  alledings nicht. Das Verhalten von GIANT im Fehlerfall bleibt aber 
...
\end {enumerate}
  ...
  \begin {enumerate}
    ...
    befinden sich in diesem Verzeichnis. GIANT speichert alle
    Verwaltungsdateien (siehe 
  ...
  \begin {enumerate}
    ...
    denen aber keine Referenz in der Projekdatei existiert, gehören
    nicht zum Projekt.
  ...
  \index{Verwaltungsdateien für Anzeigefenster}
  ...
  \index{Verwaltungsdateien für IML-Teilgraphen}
  ...
  \index{Verwaltungsdateien für Knoten-Annotationen}
  ...
  \begin {enumerate}
   ...
   \item
   Alle Knoten-Annotationen werden in einer Verwaltungsdatei gespeichert (von
   dieser Datei darf es immer nur eine im Projekt geben).
