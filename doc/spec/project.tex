% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.11 $
%  $Date: 2003/02/13 15:28:13 $
%  $Author: schwiemn $
%
%  Description:
%
...
IML-Teilgraphen und Anzeigefenster.\\
...
man das Projekt neu speichert und das alte löscht). 
...
Projekt gleichzeitig geöffnet sein darf. Voraussetzung hierfür ist allerdings, dass dies 
von der Reflektion zum IML-Graphen unterstützt wird.
  ...
  Im Projektverzeichnis befinden sich ein Unterverzeichnis für die Verwaltungsdateien für Anzeigefenster  
  und ein Unterverzeichnis für die Verwaltungsdateien für IML-Teilgraphen. 
  ...
  Alternativ dazu kann der Benutzer den Pfad zur IML-Graph Datei auch selbst eingeben.
  ...
  Beim Laden eines Projektes wird überprüft, ob die in der Projektdatei gespeicherte Prüfsumme
  ...
  eines Anzeigefensters. Gespeichert werden insbesondere:
...
\section {Grundlegendes Verhalten von GIANT beim Speichern von Projekten} 
  ...
  geschrieben, falls nein bleibt der Zustand nach dem letzten Speichern erhalten.
  \gq{alles Speichern} kann auch während dem Betrieb von GIANT durch den Benutzer veranlasst werden.
  ...
  Hinsichtlich der Persitenz von Anzeigenfenstern sind folgende Fälle zu unterscheiden:
    ...
    Wird ein solches Anzeigefenster geschlossen, so fragt GIANT nach, ob es eventuelle Änderungen speichern soll
    oder nicht. Falls ja, werden eventuelle Änderungen in die für das Anzeigefenster bereits 
    vorhandene Verwaltungsdatei geschrieben, anderenfalls bleibt der Zustand des Anzeigefensters nach der letzten
    ...
    Nicht persistente Anzeigefenster (typischerweise vom Benutzer neu erzeugte Anzeigefenster) werden in der
  ...
  IML-Teilgraphen können über die Funktion \gq{Alles Speichern} (siehe oben) gespeichert werden.
  ...
  Beim Ausführen der Funktion \gq{Alles Speichern} werden sämtliche Änderungen für die IML-Teilgraphen 
  ...
  Selektiv kann auch ein einzelner IML-Teilgraph gespeichert werden, hierbei wird dann die bereits bestehende
  Verwaltungsdatei aktualisiert oder neu erzeugt, falls es für diesen IML-Teilgraphen noch keine Verwaltungsdatei
  gibt.
