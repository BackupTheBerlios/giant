% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.7 $
%  $Date: 2003/02/13 12:18:58 $
%  $Author: schwiemn $
%
%  Description:
%
...
\section {Greundlegendes Verhalten von GIANT beim Speichern von Projekten} 

Beim Beenden von GIANT werden automatisch alle zum Speichern markierten Anzeigefenster
und alle IML-Teilgraphen in die entsprechenden Verwaltungsdateien geschrieben. Nicht
zum Speichern markierte Anzeigefenster gehen verloren.\\
Dieses Speichern kann der Benutzer auch explizit während des Betriebs von GIANT 



  Im HAUPTMENÜ sind alle für das Projekt definierten Anzeigefenster
