...
% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.10 $
%  $Date: 2003/02/13 15:06:44 $
%  $Author: schwiemn $
%
%  Description:
%
...
von der Reflektion zum IML-Graphen unterstützt wird.
  ...
  Im Projektverzeichnis befinden sich ein Unterverzeichnis für Verwaltungsdateien für Anzeigefenster
  und ein Unterverzeichnis  für alle zum Projekt gehörenden 
...
.\\
  ...
  der Prüfsumme der zu ladenen IML-Graph Datei entspricht. 
