% ==============================================================================
%  $RCSfile: project.tex,v $, $Revision: 1.9 $
%  $Date: 2003/02/13 13:53:41 $
%  $Author: schwiemn $
%
%  Description:
%
...
von der Reflektion zum IML-Graphen unterstützt wird.
  ...
  Im Projektverzeichnis befindet sich auch die Datei für jedes gespeicherte Anzeigefenster und 
  für jeden gespeicherten IML-Teilgraphen. In jedem Projektverzeichnis darf nur ein Projekt 
  gespeichert werden.
