% ==============================================================================
%  $RCSfile: product.tex,v $, $Revision: 1.41 $
...
nacheinander ausgeführt werden. Mittels der Anfragesprache GSL 
(siehe \ref{GIANT Scripting Language}) und mittels der über die 
