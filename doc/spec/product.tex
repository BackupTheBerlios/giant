% ==============================================================================
%  $RCSfile: product.tex,v $, $Revision: 1.37 $
...
haben.
  ...
  Weitere Informationen sind in Abschnitt \ref{Config
...
Weitere Informationen sind in Abschnitt \ref{Project Persistenz von
Knoten-Annotationen} verfügbar.
