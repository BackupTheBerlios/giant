% ==============================================================================
%  $RCSfile: product.tex,v $, $Revision: 1.21 $
...
Unzulässige Namen werden generell abgelehnt und führen zu einer Fehlermeldung.
  ...
  \begin {enumerate}
    ...
    \item Name eines Pins: STANDARD FILENAME
          Dieser Name muss innerhalb eines Anzeigefensters eindeutig sein.
...
Hier werden grundlegende Konzepte der Bedienung von GIANT beschrieben.
  ...
  \begin{enumerate}
   ...
   Alle Fenster-Knoten und Knaten innerhalb des Rahmens, 
   die noch nicht selektiert sind, werden der aktuellen Selektion 
   hinzugefügt.\\
   Alle Fenster-Knoten und Knaten innerhalb des Rahmens, 
   die bereits selektiert
   sind, werden aus der aktuellen Selektion entefernt.
...
in Anzeigefenster}
  \label{Verhalten beim Einfügen von IML-Teilgraphen und Selektionen
   ...
   \begin {enumerate}
     ...
     \item
     Befindet sich die Maus über den Bereich des Anzeigefensters, wo
   ...
   \begin{enumerate}
     ...
     \item
     Das Layout für den IML-Teilgraphen wird vor dem Einfügen gemäß einem
...
\begin {enumerate}
  ...
  \item 
  Die Fenster-Knoten werden immer eintlang einer Strecke von diesem
