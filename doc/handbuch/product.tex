...
Es ist auch möglich, GSL Skripte im Zusammenhang mit Knoten
über Popup-Menüs zu starten. Mehr Info hierzu unter Abschnitt \ref{Node-Popup-Menü}.\\
...
von IML-Graphen in Anzeigefenstern folgende drei Schritte sequentiell
nacheinander ausgeführt werden. Mittels der Anfragesprache GSL 
(siehe Kapitel \ref{GIANT Scripting Language}) und mittels der über die 
GUI zugänglichen Funktionen (beschrieben ab Kapitel \ref{Kapitel-Funktionale Anforderungen})
