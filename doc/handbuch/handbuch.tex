% ==============================================================================
%  $RCSfile: handbuch.tex,v $, $Revision: 1.15 $
%  $Date: 2003/09/20 12:22:35 $
%  $Author: birdy $
%
...
und die nötige Software sowie die Installation von GIANT
...
und wie sie vom Benutzer ausgeführt werden können, um dem Benutzer einen
schnellen Start der Arbeit mit GIANT zu ermöglichen.\\
...
%
\chapter{Beschreibung der Benutzeroberfläche}
