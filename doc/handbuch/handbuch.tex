% ==============================================================================
%  $RCSfile: handbuch.tex,v $, $Revision: 1.12 $
%  $Date: 2003/09/18 18:16:51 $
%  $Author: koppor $
%
...
\newcommand\version{Version 1.1 (Vorabversion)\xspace}
...
Möglichkeiten von GIANT vorgestellt und kurz beschrieben.
...
Hier wird die zum Betrieb von GIANT nötige Hardware 
und die nötige Software beschrieben.
...
Dieses Kapitel beschreibt wichtige Begriffe, die für das Arbeiten mit
GIANT und das Verständnis dieser Anleitung wichtig sind, und Prinzipien
bei der Arbeit mit GIANT.

\input{konzepteundbegriffe}
...
alle Buttons, Menüs und Funktionen. Dies ist als Nachschlagewerk über
alle Elemente der graphischen Benutzeroberfläche (GUI) gedacht.
...
Dieses Kapitel beschreibt einige häufig vorkommende Analysen mit GIANT
und wie sie vom Benutzer ausgeführt werden können.
...
Soweit für das Verständnis von GIANT nötig, sind auch Interna des
