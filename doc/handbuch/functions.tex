% ==============================================================================
%  $RCSfile: functions.tex,v $, $Revision: 1.8 $
%  $Date: 2003/07/06 12:40:02 $
%  $Author: birdy $
%
%  Description: 
%
  ...
  \subsection{Selektionsauswahlliste} \label{Selektionsauswahlliste}
	...
	Der Benutzer startet die Funktion mit einem Rechtsklick 
	 ...
	 wurde ggf. automatisch angepasst.
	  ...
	  \begin{itemize}
	   \item{Der Benutzer startet den UseCase durch Rechtsklick auf die zu kopierende
      ...
      \item Delete Selection\\
	   ...
	   \begin{itemize}
	    \item{Der Benutzer startet den UseCase durch Rechtsklick auf die zu
