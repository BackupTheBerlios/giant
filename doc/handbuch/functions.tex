% ==============================================================================
%  $RCSfile: functions.tex,v $, $Revision: 1.16 $
%  $Date: 2003/09/09 22:21:48 $
%  $Author: birdy $
%
%  Description: 
%
...
Subgraph List.
  ...
  In der Menüleiste befinden sich folgende Einträge:
    ...
    erscheint ebenfalls eine Fehlermeldung.}
	 ...
	 Gibt Informationen über die Version von GIANT und die Autoren von GIANT aus.
	 **** Node Info Fenster wird angezeigt. Gehört hier doch nicht hin? ****
...
\index{Anzeigefenster}
  ...
  Zoom-Kontrolle. Dieser Teil kann durch Verschieben des entsprechenden
  Buttons unten an der Trennleiste in der Größe verändert werden.
 ...
 Einfügen von Teilgraphen, so verändert sich auch die Minimap entsprechend.
  ...
  \subsection{Visualisierung der Knoten und Kanten}
    ...
    geklickt wird, öffnet sich das folgende
    Popup-Menü:
     \begin{itemize}
       \item Zoom to edge **** gibt es das noch?\\
  ...
  \subsection{Selektionsauswahlliste} \label{Selektionsauswahlliste}
	...
	Der Benutzer startet die Funktion mit einem Rechtsklick 
      ...
      \item Zoom To Fill Window **** Wird das noch eingebaut?\\
...
\section{Knoten-Informationsfenster} \label{Knoten-Informationsfenster}
    ...
    Unter der Liste befinden sich nebeneinander die Buttons
