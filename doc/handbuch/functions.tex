% ==============================================================================
%  $RCSfile: functions.tex,v $, $Revision: 1.14 $
...
°./giant  project-file [-g graph-file] [-e script-file] [-c config-file] | -h | -v°

project-file ist der Filename der Projektdatei, graph-file der Filename
des IML-Graphen, script-file ein auszuführender GSL-Ausdruck, config-file die
optional anzugebende globale Konfigurationsdatei, siehe Abschnitt
\ref{config-allgemeines-punkt2}.

Die Option -h steht für Hilfe, -v für ausführlicheres Output auf
der Konsole (z.B. xterm).
...
Im Fenster befinden sich zwei Listen, Window List und
Subgraph List.
    ...
    erscheint ebenfalls eine Fehlermeldung.}
     ...
     \subsubsection {Untermenü Tools}  \label{Main-Window-Tools}
	  ...
	  Es werden alle
          ...
          Graph-Knoten gibt, aus der Annotationsdatei gelöscht.
...
\index{Anzeigefenster}
  ...
  Zoom-Kontrolle. Dieser Teil kann horizontal verschoben werden.
 ...
 Einfügen von Teilgraphen, so verändert sich auch die Minimap entsprechend.
          ...
          \item Delete\\
	       ...
	       \begin{itemize}
	        ...
	        \item{Nach dem nächsten Speichern des Projektes ist die Annotation
		      dauerhaft gelöscht.}
	     \end{itemize} 
          \item {Execute GSL Script on Node}\\ % ****
  ...
  \subsection{Selektionsauswahlliste} \label{Selektionsauswahlliste}
    ...
    \begin{enumerate}
	  ...
	  \item{Der Benutzer gibt dort einen zulässigen Namen 
           (siehe \ref{afa Bezeichnertypen}) für die neue Selektion 
  ...
  % ****** Kommt das noch? Sonst rauswerfen.
...
\section{Knoten-Informationsfenster} \label{Knoten-Informationsfenster}
    ...
    und Knoten-Typ, folgende Elemente:
...
\begin {enumerate} 
 \item Anzeige der zu layoutenden Selektion mit dem zu layoutenden Fenster
 \item {Auswahl des Layoutalgorithmus}\\
       Über die Tabs im Fenster kann der Layoutalgorithmus ausgewählt werden,
 ...
 \item {Ggf. Auswahl der für das Layout der Knoten zu berücksichtigenden Klassenmengen
	...
	(Mehrfachmarkierungen sind möglich), werden für das Layout berücksichtigt.
 \item OK Button
 \item Cancel Button
\end {enumerate}
