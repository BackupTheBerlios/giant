...
\hspace{10mm}<global\_settings vis\_window\_background\_color="RGB:20/20/20"/>\\
festgelegt.\\
...
\hspace{10mm}<default\_node\_setting>\\
\hspace{15mm}    icon         = "test\_node\_icon\_default\_1.xpm"\\
\hspace{15mm}    text\_color   = "RGB:AA/AA/AA"\\
\hspace{15mm}   border\_color = "RGB:AA/AA/AA"\\
\hspace{15mm}    fill\_color   = "white">\\
\hspace{10mm}</default\_node\_setting>\\
genauer festgelegt.\\
...
\hspace{10mm}  <node\_class\_specific\_setting \\
\hspace{15mm}    icon         = "test\_node\_icon\_blue\_1.xpm"\\
\hspace{15mm}    text\_color   = "blue"\\
\hspace{15mm}    border\_color = "blue"\\
\hspace{15mm}    fill\_color   = "white">\\ 
...
\hspace{15mm}    <node\_attribute attribute\_name  = "SLoc"/> \\
...
°<node\_class     node\_class\_name = "IML\_Root"/>°\\
°<node\_class     node\_class\_name = "HPGNode"/>°\\
°<node\_class     node\_class\_name = "OC\_Parameter"/>°\\        
°<node\_class     node\_class\_name = "TC\_Boolean"/>°\\
...
\hspace{10mm}  <node\_class\_specific\_setting \\
\hspace{15mm}    icon         = "test\_node\_icon\_red\_1.xpm"\\
\hspace{15mm}   text\_color   = "red"\\
\hspace{15mm}    border\_color = "red"\\
\hspace{15mm}    fill\_color   = "white">\\ 
    
\hspace{15mm}    <node\_attribute attribute\_name  = "SLoc"/>\\    
\hspace{15mm}   <node\_attribute attribute\_name  = "Type\_Size"/>\\        
\hspace{15mm}   <node\_class     node\_class\_name = "TC\_Boolean"/>\\      
\hspace{10mm}  </node\_class\_specific\_setting>\\
