% ==============================================================================
%  $RCSfile: config.tex,v $, $Revision: 1.14 $
...
Im Folgenden sind die möglichen Einstellungen, die im Config-File sein können, aufgelistet,
...
\verbatiminput{global_config.xml}
  ...
  ****** Hier mehr Info dazu, sobald implementiert.
