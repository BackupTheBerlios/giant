% ==============================================================================
%  $RCSfile: tutorial.tex,v $, $Revision: 1.2 $
%  $Date: 2003/09/20 13:36:09 $
%  $Author: birdy $
%
...
Wir können nun sehen, daß die Selektion farbig markiert wird.\\
...
Es erscheint der Set Operation Dialog. Wir wählen (siehe Bild) \\
...
Wir können mit der linken Maustaste durch Drag&Drop Knoten
verschieben. Es kann vorkommen, daß Knoten aufeinander liegen,
sie können dann damit auseinandergeschoben werden.\\

Durch Klick mit der rechten Maustaste auf einen freien 
